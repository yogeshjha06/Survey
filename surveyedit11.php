                ...
                <section class="section">
                    <div class="row">
                        <div class="col-lg-12">
                         ...
                         <?php
                         $sql = "SELECT * FROM `11_child` WHERE `id` = '$survey_id'";
                         ...
                         ?>
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv0" class="col-sm-2 col-form-label">Male</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv0_done" class="col-sm-2 col-form-label">Female</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv1_done" class="col-sm-2 col-form-label">Female</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv2" class="col-sm-2 col-form-label">Male</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv2_done" class="col-sm-2 col-form-label">Female</label>
                                            <div class="col-sm-10">
                                    ...
                                    if (isset($_POST['submit'])) {
                                        ...
                                        //insert data query
                                        $res = mysqli_query($con, "UPDATE `11_child` SET `m1`='$opv0',`f1`='$opv0_done',`m2`='$opv1',`f2`='$opv1_done',`m3`='$opv2',`f3`='$opv2_done',`date`='$date_now' WHERE `id`='$survey_id'");
