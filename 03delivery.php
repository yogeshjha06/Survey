                ...
                <section class="section">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Institutional Delivery Survey</h5>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="row mb-4">
                                            <label for="ins1" class="col-sm-2 col-form-label">Institutional Delivery Target</label>
                                            <div class="col-sm-10">
                                                <input id="ins1" placeholder="Enter Number" name="ins1" type="number" class="form-control" required>
                                            </div>
                                        </div>

                                        <div class="row mb-4">
                                            <label for="ins2" class="col-sm-2 col-form-label">Institutional Delivery Achievement</label>
                                            <div class="col-sm-10">
                                                <input id="ins2" placeholder="Enter Number" name="ins2" type="number" class="form-control" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-4">
                                            <label for="skill" class="col-sm-2 col-form-label">Skilled Birth Attendent (SBA) Assisted  Birth</label>
                                            <div class="col-sm-10">
                                                <input id="skill" placeholder="Enter Number" name="skill" type="number" class="form-control" required>
                                            </div>
                                        </div>

                                        <div class="row mb-4">
                                            <label for="non" class="col-sm-2 col-form-label">Non Assisted  Birth</label>
                                            <div class="col-sm-10">
                                                <input id="non" placeholder="Enter Number" name="non" type="number" class="form-control" required>
                                            </div>
                                        </div>
                                    ...
                                    if (isset($_POST['submit'])) {
                                        ...
                                        $non     =  mysqli_real_escape_string($con, $_POST['non']);
                                        ...
                                        //insert data query
                                        $res = mysqli_query($con, "INSERT INTO `02_delivery`(`project`, `scheme`, `month`, `district`, `block`, `sector`, `target`, `archived`, `skill`, `non_assisted`, `date`, `submitted`, `submitedID`) VALUES ('$project','$scheme','$month','$district1','$block1','$sector1','$ins1','$ins2','$skill','$non','$date_now','$name', '$id')");
