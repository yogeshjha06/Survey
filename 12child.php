                ...
                <section class="section">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Child Birth Status Survey</h5>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="row mb-4">
                                            <h5>Total Live Birth's Survey</h5>
                                        </div>
                                        <div class="row mb-4">
                                            <label for="opv1" class="col-sm-2 col-form-label">Male</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv2" class="col-sm-2 col-form-label">Female</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <h5>Low Birth Weight Babies Survey</h5>
                                        </div>
                                        <div class="row mb-4">
                                            <label for="opv3" class="col-sm-2 col-form-label">Male</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv4" class="col-sm-2 col-form-label">Female</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <h5>Still Births Survey</h5>
                                        </div>
                                        <div class="row mb-4">
                                            <label for="opv5" class="col-sm-2 col-form-label">Male</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv6" class="col-sm-2 col-form-label">Female</label>
                                            <div class="col-sm-10">
                                    ...
                                    if (isset($_POST['submit'])) {
                                        ...
                                        //insert data query
                                        $res = mysqli_query($con, "INSERT INTO `11_child`(`project`, `scheme`, `month`, `district`, `block`, `sector`, `m1`, `f1`, `m2`, `f2`, `m3`, `f3`, `date`, `submitted`, `submitedID`) VALUES ('$project','$scheme','$month','$district1','$block1','$sector1','$opv1','$opv2','$opv3','$opv4','$opv5','$opv6','$date_now','$name', '$id')");
