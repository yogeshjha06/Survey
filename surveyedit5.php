                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                ...
                                <center><h5 class="card-title text-primary">PENTA Survey Edit</h5></center> 
                                    <!-- General Form Elements -->
                                    <form action="#" method="POST">
                         <?php
                         $sql = "SELECT * FROM `05_penta` WHERE `id` = '$survey_id'";
                         ...
                         ?>
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv0" class="col-sm-2 col-form-label">PENTA-1 (Target)</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv0_done" class="col-sm-2 col-form-label">PENTA-1 (Achived)</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv1" class="col-sm-2 col-form-label">PENTA-2 (Target)</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv1_done" class="col-sm-2 col-form-label">PENTA-2 (Achived)</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv2" class="col-sm-2 col-form-label">PENTA-3 (Target)</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv2_done" class="col-sm-2 col-form-label">PENTA-3 (Achived)</label>
                                            <div class="col-sm-10">
                                    ...
                                    if (isset($_POST['submit'])) {
                                        ...
                                        //insert data query
                                        $res = mysqli_query($con, "UPDATE `05_penta` SET `penta1`='$opv0',`penta1_done`='$opv0_done',`penta2`='$opv1',`penta2_done`='$opv1_done',`penta3`='$opv2',`penta3_done`='$opv2_done',`date`='$date_now' WHERE `id`='$survey_id'");
