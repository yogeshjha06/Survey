...
if (!isset($_SESSION['is_login'])) {
    ...
    $row = mysqli_fetch_array($stmt); {
        ...
        {            
            $id1=$_GET['id'];
            $query="SELECT * FROM `tbl_scheme` WHERE `id`='$id1'";
            $stmt=mysqli_query($con,$query);
            $row=mysqli_fetch_array($stmt);
                $scheme=$row['scheme'];
                $sdate=$row['sdate'];
                ...
                <section class="section">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Update Scheme</h5>
                                    ...
                                    if (isset($_POST['submit'])) 
                                    {
                                        ...
                                        $res = mysqli_query($con, "UPDATE `tbl_scheme` SET `scheme`='$scheme',`sdate`='$sdate',`edate`='$edate',`status`='0' WHERE `id`='$id1'");
                                        if ($res) {                                           
                                                echo "<script>                
                                                   swal({
                                                       icon: 'success',
