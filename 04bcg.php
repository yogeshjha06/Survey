                ...
                <section class="section">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">BCG Survey</h5>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="row mb-4">
                                            <h5>At The Time of Birth</h5>
                                        </div>
                                        <div class="row mb-4">
                                            <label for="ins1" class="col-sm-2 col-form-label">BCG (Target)</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="ins2" class="col-sm-2 col-form-label">BCG Achievement</label>
                                            <div class="col-sm-10">
                                    ...
                                    if (isset($_POST['submit'])) {
                                        ...
                                        $bcg1    =  mysqli_real_escape_string($con, $_POST['ins1']);
                                        $bcg2    =  mysqli_real_escape_string($con, $_POST['ins2']);
                                        ...
                                        //insert data query
                                        $res = mysqli_query($con, "INSERT INTO `03_bcg`(`project`, `scheme`, `month`, `district`, `block`, `sector`, `bcg1`, `bcg2`, `date`, `submitted`, `submitedID`) VALUES ('$project','$scheme','$month','$district1','$block1','$sector1','$bcg1','$bcg2','$date_now','$name', '$id')");
