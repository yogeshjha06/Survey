                ...
                <section class="section">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Beneficiary Details (0-3 years) Survey</h5>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv1" class="col-sm-2 col-form-label">Number of Male As Per Survey Data</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv2" class="col-sm-2 col-form-label">Number of Female As Per Survey Data</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv4" class="col-sm-2 col-form-label">Number of Female In Anganwadi Center</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv5" class="col-sm-2 col-form-label">Number of Male As Per Survey Data</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv6" class="col-sm-2 col-form-label">Number of Female As Per Survey Data</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-10">
                                                <input id="opv7" placeholder="Enter Number" name="opv7" type="number" class="form-control" required>
                                            </div>
                                        </div>

                                        <div class="row mb-4">
                                            <label for="opv8" class="col-sm-2 col-form-label">Number of Female In Anganwadi Center</label>
                                            <div class="col-sm-10">
                                                <input id="opv8" placeholder="Enter Number" name="opv8" type="number" class="form-control" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv9" class="col-sm-2 col-form-label">Number of Male As Per Survey Data</label>
                                            <div class="col-sm-10">
                                                <input id="opv9" placeholder="Enter Number" name="opv9" type="number" class="form-control" required>
                                            </div>
                                        </div>

                                        <div class="row mb-4">
                                            <label for="opv10" class="col-sm-2 col-form-label">Number of Female As Per Survey Data</label>
                                            <div class="col-sm-10">
                                                <input id="opv10" placeholder="Enter Number" name="opv10" type="number" class="form-control" required>
                                            </div>
                                        </div>   
                                        
                                        
                                        <div class="row mb-4">
                                            <label for="opv11" class="col-sm-2 col-form-label">Number of Male In Anganwadi Center</label>
                                            <div class="col-sm-10">
                                                <input id="opv11" placeholder="Enter Number" name="opv11" type="number" class="form-control" required>
                                            </div>
                                        </div>

                                        <div class="row mb-4">
                                            <label for="opv12" class="col-sm-2 col-form-label">Number of Female In Anganwadi Center</label>
                                            <div class="col-sm-10">
                                                <input id="opv12" placeholder="Enter Number" name="opv12" type="number" class="form-control" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv13" class="col-sm-2 col-form-label">Number of Male As Per Survey Data</label>
                                            <div class="col-sm-10">
                                                <input id="opv13" placeholder="Enter Number" name="opv13" type="number" class="form-control" required>
                                            </div>
                                        </div>

                                        <div class="row mb-4">
                                            <label for="opv14" class="col-sm-2 col-form-label">Number of Female As Per Survey Data</label>
                                            <div class="col-sm-10">
                                                <input id="opv14" placeholder="Enter Number" name="opv14" type="number" class="form-control" required>
                                            </div>
                                        </div>   
                                        
                                        
                                        <div class="row mb-4">
                                            <label for="opv15" class="col-sm-2 col-form-label">Number of Male In Anganwadi Center</label>
                                            <div class="col-sm-10">
                                                <input id="opv15" placeholder="Enter Number" name="opv15" type="number" class="form-control" required>
                                            </div>
                                        </div>

                                        <div class="row mb-4">
                                            <label for="opv16" class="col-sm-2 col-form-label">Number of Female In Anganwadi Center</label>
                                            <div class="col-sm-10">
                                                <input id="opv16" placeholder="Enter Number" name="opv16" type="number" class="form-control" required>
                                            </div>
                                        </div>
                                    ...
                                    if (isset($_POST['submit'])) {
                                        ...
                                        $opv7    =  mysqli_real_escape_string($con, $_POST['opv7']);
                                        $opv8    =  mysqli_real_escape_string($con, $_POST['opv8']);

                                        $opv9     =  mysqli_real_escape_string($con, $_POST['opv9']);
                                        $opv10    =  mysqli_real_escape_string($con, $_POST['opv10']);
                                        $opv11    =  mysqli_real_escape_string($con, $_POST['opv11']);
                                        $opv12    =  mysqli_real_escape_string($con, $_POST['opv12']);

                                        $opv13    =  mysqli_real_escape_string($con, $_POST['opv13']);
                                        $opv14    =  mysqli_real_escape_string($con, $_POST['opv14']);
                                        $opv15    =  mysqli_real_escape_string($con, $_POST['opv15']);
                                        $opv16    =  mysqli_real_escape_string($con, $_POST['opv16']);
                                        ...
                                        //insert data query
                                        $res = mysqli_query($con, "INSERT INTO `18_beneficiary`(`project`, `scheme`, `month`, `district`, `block`, `sector`, `m1`, `f1`, `m2`, `f2`, `m3`, `f3`, `m4`, `f4`, `m5`, `f5`, `m6`, `f6`, `m7`, `f7`, `m8`, `f8`, `date`, `submitted`, `submitedID`) VALUES ('$project','$scheme','$month','$district1','$block1','$sector1','$opv1','$opv2','$opv3','$opv4','$opv5','$opv6','$opv7','$opv8','$opv9','$opv10','$opv11','$opv12','$opv13','$opv14','$opv15','$opv16','$date_now','$name', '$id')");
