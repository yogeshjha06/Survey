                ...
                <section class="section">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">ANC Survey</h5>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="row mb-4">
                                            <label for="anc1" class="col-sm-2 col-form-label">ANC- 1 Target</label>
                                            <div class="col-sm-10">
                                                <input id="anc1" placeholder="Enter Number" name="anc1" type="number" class="form-control" required>
                                            </div>
                                        </div>

                                        <div class="row mb-4">
                                            <label for="anc1_done" class="col-sm-2 col-form-label">Achievement of ANC- 1</label>
                                            <div class="col-sm-10">
                                                <input id="anc1_done" placeholder="Enter Number" name="anc1_done" type="number" class="form-control" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-4">
                                            <label for="anc2" class="col-sm-2 col-form-label">ANC- 2 Target</label>
                                            <div class="col-sm-10">
                                                <input id="anc2" placeholder="Enter Number" name="anc2" type="number" class="form-control" required>
                                            </div>
                                        </div>

                                        <div class="row mb-4">
                                            <label for="anc2_done" class="col-sm-2 col-form-label">Achievement of ANC- 2</label>
                                            <div class="col-sm-10">
                                                <input id="anc2_done" placeholder="Enter Number" name="anc2_done" type="number" class="form-control" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-4">
                                            <label for="anc3" class="col-sm-2 col-form-label">ANC- 3 Target</label>
                                            <div class="col-sm-10">
                                                <input id="anc3" placeholder="Enter Number" name="anc3" type="number" class="form-control" required>
                                            </div>
                                        </div>

                                        <div class="row mb-4">
                                            <label for="anc3_done" class="col-sm-2 col-form-label">Achievement of ANC- 3</label>
                                            <div class="col-sm-10">
                                                <input id="anc3_done" placeholder="Enter Number" name="anc3_done" type="number" class="form-control" required>
                                            </div>
                                        </div>


                                        <div class="row mb-4">
                                            <h5>Stage Four Info</h5>
                                        </div>
                                        <div class="row mb-4">
                                            <label for="anc4" class="col-sm-2 col-form-label">ANC- 4 Target</label>
                                            <div class="col-sm-10">
                                                <input id="anc4" placeholder="Enter Number" name="anc4" type="number" class="form-control" required>
                                            </div>
                                        </div>

                                        <div class="row mb-4">
                                            <label for="anc4_done" class="col-sm-2 col-form-label">Achievement of ANC- 4</label>
                                            <div class="col-sm-10">
                                                <input id="anc4_done" placeholder="Enter Number" name="anc4_done" type="number" class="form-control" required>
                                            </div>
                                        </div>
                                    ...
                                    if (isset($_POST['submit'])) {
                                        ...
                                        $anc1               =  mysqli_real_escape_string($con, $_POST['anc1']);
                                        $anc1_done          =  mysqli_real_escape_string($con, $_POST['anc1_done']);
                                        $anc2               =  mysqli_real_escape_string($con, $_POST['anc2']);
                                        $anc2_done          =  mysqli_real_escape_string($con, $_POST['anc2_done']);
                                        $anc3               =  mysqli_real_escape_string($con, $_POST['anc3']);
                                        $anc3_done          =  mysqli_real_escape_string($con, $_POST['anc3_done']);
                                        $anc4               =  mysqli_real_escape_string($con, $_POST['anc4']);
                                        $anc4_done          =  mysqli_real_escape_string($con, $_POST['anc4_done']);
                                        ...
                                        //insert data query
                                        $res = mysqli_query($con, "INSERT INTO `01_anc`(`scheme`, `project`, `month`, `district`, `block`, `sector`, `anc_due`, `anc_done`, `anc2`, `anc2_done`, `anc3`, `anc3_done`, `anc4`, `anc4_done`, `date`, `submitted`, `submitedID`) VALUES ('$scheme','$project','$month','$district1','$block1','$sector1','$anc1','$anc1_done','$anc2','$anc2_done','$anc3','$anc3_done','$anc4','$anc4_done','$date_now','$name', '$id')");
