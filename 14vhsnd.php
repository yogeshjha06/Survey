                ...
                <section class="section">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">VHSND Survey</h5>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv1" class="col-sm-2 col-form-label">Anganwadi Centers (Target)</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv2" class="col-sm-2 col-form-label">VHSND Conducted (Achivement)</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv3" class="col-sm-2 col-form-label">Beneficiaries availed services</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv4" class="col-sm-2 col-form-label">Beneficiaries counselled</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv5" class="col-sm-2 col-form-label">LS</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv6" class="col-sm-2 col-form-label">CDPO</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv7" class="col-sm-2 col-form-label">MOIC</label>
                                            <div class="col-sm-10">
                                    ...
                                    if (isset($_POST['submit'])) {
                                        ...
                                        //insert data query
                                        $res = mysqli_query($con, "INSERT INTO `13_vhsnd`(`project`, `scheme`, `month`, `district`, `block`, `sector`, `angbanri`, `vhsnd`, `beneficiaries1`, `beneficiaries2`, `ls`, `cdpo`, `moic`, `date`, `submitted`, `submitedID`) VALUES ('$project','$scheme','$month','$district1','$block1','$sector1','$opv1','$opv2','$opv3','$opv4','$opv5','$opv6','$opv7','$date_now','$name', '$id')");
