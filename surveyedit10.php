                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                ...
                                <center><h5 class="card-title text-primary">Full Immunization Survey Edit</h5></center> 
                                    <!-- General Form Elements -->
                                    <form action="#" method="POST">
                         <?php
                         $sql = "SELECT * FROM `10_full` WHERE `id` = '$survey_id'";
                         ...
                         ?>
                                    ...
                                    if (isset($_POST['submit'])) {
                                        ...
                                        //insert data query
                                        $res = mysqli_query($con, "UPDATE `10_full` SET `full`='$opv0',`full1`='$opv0_done',`date`='$date_now' WHERE `id`='$survey_id'");
