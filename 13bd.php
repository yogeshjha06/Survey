                ...
                <section class="section">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Birth & Death Survey</h5>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv1" class="col-sm-2 col-form-label">Number of Children Born Live</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv2" class="col-sm-2 col-form-label">Number of Children Reported For Birth Certificate</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv3" class="col-sm-2 col-form-label">Total Number of Deaths In The Host Area</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv4" class="col-sm-2 col-form-label">Total Number of Dead Persons Reported For Death Certificate</label>
                                            <div class="col-sm-10">
                                    ...
                                    if (isset($_POST['submit'])) {
                                        ...
                                        //insert data query
                                        $res = mysqli_query($con, "INSERT INTO `12_birth_death`(`project`, `scheme`, `month`, `district`, `block`, `sector`, `live_born`, `birth_certificate`, `death`, `death_certificate`, `date`, `submitted`, `submitedID`) VALUES ('$project','$scheme','$month','$district1','$block1','$sector1','$opv1','$opv2','$opv3','$opv4','$date_now','$name', '$id')");
