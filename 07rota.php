                ...
                <section class="section">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Rota Virus Survey</h5>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv1" class="col-sm-2 col-form-label">Rota Virus-1 (Target)</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv2" class="col-sm-2 col-form-label">Rota Virus-1 Achievement</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv3" class="col-sm-2 col-form-label">Rota Virus-2 (Target)</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv4" class="col-sm-2 col-form-label">Rota Virus-2 Achievement</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv5" class="col-sm-2 col-form-label">Rota Virus-3 (Target)</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv6" class="col-sm-2 col-form-label">Rota Virus-3 Achievement</label>
                                            <div class="col-sm-10">
                                    ...
                                    if (isset($_POST['submit'])) {
                                        ...
                                        //insert data query
                                        $res = mysqli_query($con, "INSERT INTO `06_rota`(`project`, `scheme`, `month`, `district`, `block`, `sector`, `rota1`, `rota1_done`, `rota2`, `rota2_done`, `rota3`, `rota3_done`, `date`, `submitted`, `submitedID`) VALUES ('$project','$scheme','$month','$district1','$block1','$sector1','$opv1','$opv2','$opv3','$opv4','$opv5','$opv6','$date_now','$name', '$id')");
