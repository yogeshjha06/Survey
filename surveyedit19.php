                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                ...
                                <center><h5 class="card-title text-primary">Beneficiary Details (3-6 years) Survey Edit</h5></center> 
                                    <!-- General Form Elements -->
                                    <form action="#" method="POST">
                         <?php
                            $sql = "SELECT * FROM `19_beneficiary_3_6` WHERE `id` = '$survey_id'";
                         ...
                         ?>
                                    ...
                                    if (isset($_POST['submit'])) {
                                        ...
                                        //insert data query
                                        $res = mysqli_query($con, "UPDATE `19_beneficiary_3_6` SET `m1`='$opv0',`f1`='$opv0_done',`m2`='$opv1',`f2`='$opv1_done',`m3`='$opv2',`f3`='$opv2_done',`m4`='$opv3',`f4`='$opv3_done',`m5`='$opv4',`f5`='$opv4_done',`m6`='$opv5',`f6`='$opv5_done',`date`='$date_now' WHERE `id`='$survey_id'");
