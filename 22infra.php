                ...
                <section class="section">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Infrastructure Details Survey</h5>
                                    ...
                                    if (isset($_POST['submit'])) {
                                        ...
                                        //insert data query
                                        $res = mysqli_query($con, "INSERT INTO `21_infra`(`project`, `scheme`, `month`, `district`, `block`, `sector`, `total_awc`, `gov_building`, `rent_building`, `other_rent`, `school`, `panchyat`, `open_area`, `water`, `toilet`, `rain_water`, `electricity`, `date`, `submitted`, `submitedID`) VALUES ('$project','$scheme','$month','$district1','$block1','$sector1','$opv1','$opv2','$opv3','$opv4','$opv5','$opv6','$opv7','$opv8','$opv9','$opv10','$opv11','$date_now','$name', '$id')");
