                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                ...
                                <center><h5 class="card-title text-primary">Child Birth Survey Edit</h5></center> 
                                    <!-- General Form Elements -->
                                    <form action="#" method="POST">
                         <?php
                         $sql = "SELECT * FROM `13_vhsnd` WHERE `id` = '$survey_id'";
                         ...
                         ?>
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv0" class="col-sm-2 col-form-label">Anganwadi Centers (Target)</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv0_done" class="col-sm-2 col-form-label">VHSND Conducted (Achivement)</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv1" class="col-sm-2 col-form-label">Beneficiaries availed services</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv1_done" class="col-sm-2 col-form-label">Beneficiaries counselled</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv2" class="col-sm-2 col-form-label">LS</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv2_done" class="col-sm-2 col-form-label">CDPO</label>
                                            <div class="col-sm-10">
                                                <input id="opv2_done" name="opv2_done" type="number" class="form-control" value="<?php echo$opv2_done; ?>"  required>
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                            <label for="opv3" class="col-sm-2 col-form-label">MOIC</label>
                                            <div class="col-sm-10">
                                    ...
                                    if (isset($_POST['submit'])) {
                                        ...
                                        //insert data query
                                        $res = mysqli_query($con, "UPDATE `13_vhsnd` SET `angbanri`='$opv0',`vhsnd`='$opv0_done',`beneficiaries1`='$opv1',`beneficiaries2`='$opv1_done',`ls`='$opv2',`cdpo`='$opv2_done',`moic`='$opv3',`date`='$date_now' WHERE `id`='$survey_id'");
