                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                ...
                                <center><h5 class="card-title text-primary">Beneficiary Details (Adolscent) Survey Edit</h5></center> 
                                    <!-- General Form Elements -->
                                    <form action="#" method="POST">
                         <?php
                            $sql = "SELECT * FROM `20_beneficiary_adol` WHERE `id` = '$survey_id'";
                         ...
                         ?>
                                    ...
                                    if (isset($_POST['submit'])) {
                                        ...
                                        //insert data query
                                        $res = mysqli_query($con, "UPDATE `20_beneficiary_adol` SET `m1`='$opv0',`f1`='$opv0_done',`m2`='$opv1',`f2`='$opv1_done',`date`='$date_now' WHERE `id`='$survey_id'");
