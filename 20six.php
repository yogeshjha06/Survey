                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="row mb-4">
                                            <h5>Stage One Survey (3-4 Years)</h5>
                                        </div>
                                        <div class="row mb-4">
                                        ...
                                        <div class="row mb-4">
                                            <h5>Stage Two Survey (4-5 Years)</h5>
                                        </div>
                                        ...
                                        <div class="row mb-4">
                                            <h5>Stage Three Survey (5-6 Years)</h5>
                                        </div>
                                    ...
                                    if (isset($_POST['submit'])) {
                                        ...
                                        //insert data query
                                        $res = mysqli_query($con, "INSERT INTO `19_beneficiary_3_6`(`project`, `scheme`, `month`, `district`, `block`, `sector`, `m1`, `f1`, `m2`, `f2`, `m3`, `f3`, `m4`, `f4`, `m5`, `f5`, `m6`, `f6`, `date`, `submitted`, `submitedID`) VALUES ('$project','$scheme','$month','$district1','$block1','$sector1','$opv1','$opv2','$opv3','$opv4','$opv5','$opv6','$opv7','$opv8','$opv9','$opv10','$opv11','$opv12','$date_now','$name', '$id')");
