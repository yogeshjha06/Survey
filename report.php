               ...
               <table id="datatablesSimple"  class="table table-borderless datatable">
                    ...
                    <?php           
                                    if($designation=="Admin")
                                        $query = "SELECT * FROM `1_immunization` ORDER BY id DESC";
                                    elseif ($designation=="DSWO")
                                        $query = "SELECT * FROM `1_immunization` WHERE `district`='$district' AND `block`='$block' ORDER BY id DESC";
                                    else
                                        $query = "SELECT * FROM `1_immunization` WHERE `district`='$district' AND `block`='$block' AND `sector`='$sector' ORDER BY id DESC";
                                ...
                                while ($row = mysqli_fetch_array($stmt, MYSQLI_ASSOC))     
                                    {   
                                        ...
                                        <td>
                                        <a href='delete1.php?id=$row[id]&action=1' class='btn btn-outline-danger'><i class='fa-solid fa-trash-can'></i> &nbsp; Remove</a></td>
                                    </tr>
                                    ";                                       
                                    $beneficary1++;  
           ...
           <div style="padding-top: 10px;" class="col-lg-12">
             ...
             <div  id="GFG1">
               ...
               <table id="tableSurvey" class="table table-borderless datatable">
                    ...
                    <?php           
                                if($designation=="Admin")
                                    $query = "SELECT * FROM `01_anc` ORDER BY id DESC";
                                elseif ($designation=="DSWO")
                                    $query = "SELECT * FROM `01_anc` WHERE `district`='$district' AND `block`='$block' ORDER BY id DESC";
                                else
                                    $query = "SELECT * FROM `01_anc` WHERE `district`='$district' AND `block`='$block' AND `sector`='$sector' ORDER BY id DESC";
                                ...
                                while ($row = mysqli_fetch_array($stmt, MYSQLI_ASSOC))     
                                    {   
                                        ...
                                        <td>
                                        <a href='delete1.php?id=$row[id]&anc=1' class='btn btn-outline-danger'><i class='fa-solid fa-trash-can'></i> &nbsp; Remove</a></td>
            ...
            <!-------- Institutional Delivery Survey Start  -------------->
             ...
             <div  id="GFG2">
               ...
               <table id="table2" class="table table-borderless datatable">
                    ...
                    <?php
                                if($designation=="Admin")
                                    $query = "SELECT * FROM `02_delivery` ORDER BY id DESC";
                                elseif ($designation=="DSWO")
                                    $query = "SELECT * FROM `02_delivery` WHERE `district`='$district' AND `block`='$block' ORDER BY id DESC";
                                else
                                    $query = "SELECT * FROM `02_delivery` WHERE `district`='$district' AND `block`='$block' AND `sector`='$sector' ORDER BY id DESC";
                                ...
                                while ($row = mysqli_fetch_array($stmt, MYSQLI_ASSOC))     
                                    {   
                                        ...
                                        <td>
                                        <a href='delete1.php?id=$row[id]&ins=1' class='btn btn-outline-danger'><i class='fa-solid fa-trash-can'></i> &nbsp; Remove</a></td>
             ...
             <div  id="GFG3">
               ...
               <table id="table3" class="table table-borderless datatable">
                    ...
                    <?php
                                ...
                                if($designation=="Admin")
                                    $query = "SELECT * FROM `03_bcg` ORDER BY id DESC";
                                elseif ($designation=="DSWO")    
                                    $query = "SELECT * FROM `03_bcg` WHERE `district`='$district' AND `block`='$block' ORDER BY id DESC";
                                else
                                    $query = "SELECT * FROM `03_bcg` WHERE `district`='$district' AND `block`='$block' AND `sector`='$sector' ORDER BY id DESC";
                                ...
                                while ($row = mysqli_fetch_array($stmt, MYSQLI_ASSOC))     
                                    {   
                                        ...
                                        <td>
                                        <a href='delete1.php?id=$row[id]&BCG=1' class='btn btn-outline-danger'><i class='fa-solid fa-trash-can'></i> &nbsp; Remove</a></td>
             ...
             <div  id="GFG4">
               ...
               <table id="table4" class="table table-borderless datatable">
                    ...
                    <?php
                                ...
                                if($designation=="Admin")
                                    $query = "SELECT * FROM `04_opv` ORDER BY id DESC";
                                elseif ($designation=="DSWO")
                                    $query = "SELECT * FROM `04_opv` WHERE `district`='$district' AND `block`='$block' ORDER BY id DESC";
                                else
                                    $query = "SELECT * FROM `04_opv` WHERE `district`='$district' AND `block`='$block' AND `sector`='$sector' ORDER BY id DESC";
                                ...
                                while ($row = mysqli_fetch_array($stmt, MYSQLI_ASSOC))     
                                    {   
                                        ...
                                        <td>
                                        <a href='delete1.php?id=$row[id]&opv=1' class='btn btn-outline-danger'><i class='fa-solid fa-trash-can'></i> &nbsp; Remove</a></td>
             ...
             <div  id="GFG5">
               ...
               <table id="table5" class="table table-borderless datatable">
                    ...
                    <?php
                                ...
                                if($designation=="Admin")
                                    $query = "SELECT * FROM `05_penta` ORDER BY id DESC";
                                elseif ($designation=="DSWO")
                                    $query = "SELECT * FROM `05_penta` WHERE `district`='$district' AND `block`='$block' ORDER BY id DESC";
                                else
                                    $query = "SELECT * FROM `05_penta` WHERE `district`='$district' AND `block`='$block' AND `sector`='$sector' ORDER BY id DESC";
                                ...
                                while ($row = mysqli_fetch_array($stmt, MYSQLI_ASSOC))     
                                    {   
                                        ...
                                        <td>
                                        <a href='delete1.php?id=$row[id]&penta=1' class='btn btn-outline-danger'><i class='fa-solid fa-trash-can'></i> &nbsp; Remove</a></td>
             ...
             <div  id="GFG6">
               ...
               <table id="table6" class="table table-borderless datatable">
                    ...
                    <?php
                                ...
                                if($designation=="Admin")
                                    $query = "SELECT * FROM `06_rota` ORDER BY id DESC";
                                elseif ($designation=="DSWO")
                                    $query = "SELECT * FROM `06_rota` WHERE `district`='$district' AND `block`='$block' ORDER BY id DESC";
                                else
                                    $query = "SELECT * FROM `06_rota` WHERE `district`='$district' AND `block`='$block' AND `sector`='$sector' ORDER BY id DESC";
                                ...
                                while ($row = mysqli_fetch_array($stmt, MYSQLI_ASSOC))     
                                    {   
                                        ...
                                        <td>
                                        <a href='delete1.php?id=$row[id]&rota=1' class='btn btn-outline-danger'><i class='fa-solid fa-trash-can'></i> &nbsp; Remove</a></td>
             ...
             <div  id="GFG7">
               ...
               <table id="table7" class="table table-borderless datatable">
                    ...
                    <?php
                                ...
                                if($designation=="Admin")
                                $query = "SELECT * FROM `07_pcv` ORDER BY id DESC";
                                elseif ($designation=="DSWO")
                                $query = "SELECT * FROM `07_pcv` WHERE `district`='$district' AND `block`='$block' ORDER BY id DESC";
                                else
                                $query = "SELECT * FROM `07_pcv` WHERE `district`='$district' AND `block`='$block' AND `sector`='$sector' ORDER BY id DESC";
                                ...
                                while ($row = mysqli_fetch_array($stmt, MYSQLI_ASSOC))     
                                    {   
                                        ...
                                        <td>
                                        <a href='delete1.php?id=$row[id]&pcv=1' class='btn btn-outline-danger'><i class='fa-solid fa-trash-can'></i> &nbsp; Remove</a></td>
            ...
            <div style="padding-top: 10px;" class="col-lg-12">
             ...
             <div  id="GFG8">
               ...
               <table id="table8" class="table table-borderless datatable">
                    ...
                    <?php
                                    if($designation=="Admin")
                                    $query = "SELECT * FROM `08_ipv` ORDER BY id DESC";
                                    elseif ($designation=="DSWO")
                                    $query = "SELECT * FROM `08_ipv` WHERE `district`='$district' AND `block`='$block' ORDER BY id DESC";
                                    else
                                    $query = "SELECT * FROM `08_ipv` WHERE `district`='$district' AND `block`='$block' AND `sector`='$sector' ORDER BY id DESC";
                                ...
                                while ($row = mysqli_fetch_array($stmt, MYSQLI_ASSOC))     
                                    {   
                                        ...
                                        <td>
                                        <a href='delete1.php?id=$row[id]&ipv=1' class='btn btn-outline-danger'><i class='fa-solid fa-trash-can'></i> &nbsp; Remove</a></td>
            ...
            <div style="padding-top: 10px;" class="col-lg-12">
             ...
             <div  id="GFG9">
               ...
               <table id="table9" class="table table-borderless datatable">
                    ...
                    <?php
                                    if($designation=="Admin")
                                    $query = "SELECT * FROM `09_mr` ORDER BY id DESC";
                                    elseif ($designation=="DSWO")
                                    $query = "SELECT * FROM `09_mr` WHERE `district`='$district' AND `block`='$block' ORDER BY id DESC";
                                    else
                                    $query = "SELECT * FROM `09_mr` WHERE `district`='$district' AND `block`='$block' AND `sector`='$sector' ORDER BY id DESC";
                                ...
                                while ($row = mysqli_fetch_array($stmt, MYSQLI_ASSOC))     
                                    {   
                                        ...
                                        <td>
                                        <a href='delete1.php?id=$row[id]&mr=1' class='btn btn-outline-danger'><i class='fa-solid fa-trash-can'></i> &nbsp; Remove</a></td>
            ...
            <div style="padding-top: 10px;" class="col-lg-12">
             ...
             <div  id="GFG10">
               ...
               <table id="table10" class="table table-borderless datatable">
                    ...
                    <?php
                                    if($designation=="Admin")
                                    $query = "SELECT * FROM `10_full` ORDER BY id DESC";
                                    elseif ($designation=="DSWO")
                                    $query = "SELECT * FROM `10_full` WHERE `district`='$district' AND `block`='$block' ORDER BY id DESC";
                                    else
                                    $query = "SELECT * FROM `10_full` WHERE `district`='$district' AND `block`='$block' AND `sector`='$sector' ORDER BY id DESC";
                                ...
                                while ($row = mysqli_fetch_array($stmt, MYSQLI_ASSOC))     
                                    {   
                                        ...
                                        <td>
                                        <a href='delete1.php?id=$row[id]&full=1' class='btn btn-outline-danger'><i class='fa-solid fa-trash-can'></i> &nbsp; Remove</a>
                                        </td>
             ...
             <div  id="GFG11">
               <div  class="card-body">
                ...
                <tbody>
                    <?php
                    if($designation=="Admin")
                        $query = "SELECT * FROM `11_child` ORDER BY id DESC";
                    elseif ($designation=="DSWO")
                        $query = "SELECT * FROM `11_child` WHERE `district`='$district' AND `block`='$block' ORDER BY id DESC";
                    else
                        $query = "SELECT * FROM `11_child` WHERE `district`='$district' AND `block`='$block' AND `sector`='$sector' ORDER BY id DESC";
                    ...
                    <tr>
                        ...
                        <td>
                        <a href='delete1.php?id=" . $row['id'] . "&child=1' class='btn btn-outline-danger'><i class='fa-solid fa-trash-can'></i> &nbsp; Remove</a>
                        </td>
                    </tr>
                    ";
                    $beneficary1++;
             ...
             <div  id="GFG12">
               <div  class="card-body">
                ...
                <tbody>
                    <?php
                     if($designation=="Admin")
                    $query = "SELECT * FROM `12_birth_death` ORDER BY id DESC";
                    elseif ($designation=="DSWO")
                    $query = "SELECT * FROM `12_birth_death` WHERE `district`='$district' AND `block`='$block' ORDER BY id DESC";
                    else
                    $query = "SELECT * FROM `12_birth_death` WHERE `district`='$district' AND `block`='$block' AND `sector`='$sector' ORDER BY id DESC";
                    ...
                    <tr>
                        ...
                        <td>
                        <a href='delete1.php?id=" . $row['id'] . "&dead=1' class='btn btn-outline-danger'><i class='fa-solid fa-trash-can'></i> &nbsp; Remove</a>
                        </td>
                    </tr>
                    ";
                    $beneficary1++;
             ...
             <div  id="GFG13">
               <div  class="card-body">
                ...
                <tbody>
                    ...
                    if($designation=="Admin")
                        $query = "SELECT * FROM `13_vhsnd` ORDER BY id DESC";
                    elseif ($designation=="DSWO")
                        $query = "SELECT * FROM `13_vhsnd` WHERE `district`='$district' AND `block`='$block' ORDER BY id DESC";
                    else
                        $query = "SELECT * FROM `13_vhsnd` WHERE `district`='$district' AND `block`='$block' AND `sector`='$sector' ORDER BY id DESC";
                    $stmt = mysqli_query($con, $query);
                    ...
                    <tr>
                        ...
                        <td>
                        <a href='delete1.php?id=" . $row['id'] . "&vs=1' class='btn btn-outline-danger'><i class='fa-solid fa-trash-can'></i> &nbsp; Remove</a>
                        </td>
                    </tr>
                    ";
                    $beneficary1++;
             ...
             <div  id="GFG14">
               <div  class="card-body">
                ...
                <tbody>
                    <?php
                    if($designation=="Admin")
                        $query = "SELECT * FROM `14_snp` ORDER BY id DESC";
                    elseif ($designation=="DSWO")
                        $query = "SELECT * FROM `14_snp` WHERE `district`='$district' AND `block`='$block' ORDER BY id DESC";
                    else
                        $query = "SELECT * FROM `14_snp` WHERE `district`='$district' AND `block`='$block' AND `sector`='$sector' ORDER BY id DESC";
                    $stmt = mysqli_query($con, $query);
                    ...
                    <tr>
                        ...
                        <td>
                        <a href='delete1.php?id=" . $row['id'] . "&snp=1' class='btn btn-outline-danger'><i class='fa-solid fa-trash-can'></i> &nbsp; Remove</a>
                        </td>
                    </tr>
                    ";
                    $beneficary1++;
             ...
             <div  id="GFG15">
               <div  class="card-body">
                ...
                <tbody>
                    <?php
                        if($designation=="Admin")
                            $query = "SELECT * FROM `15_mal_nutrition` ORDER BY id DESC";
                        elseif ($designation=="DSWO")
                            $query = "SELECT * FROM `15_mal_nutrition` WHERE `district`='$district' AND `block`='$block' ORDER BY id DESC";
                        else
                            $query = "SELECT * FROM `15_mal_nutrition` WHERE `district`='$district' AND `block`='$block' AND `sector`='$sector' ORDER BY id DESC";
                    ...
                    <tr>
                        ...
                        <td>
                        <a href='delete1.php?id=" . $row['id'] . "&mal=1' class='btn btn-outline-danger'><i class='fa-solid fa-trash-can'></i> &nbsp; Remove</a>
                        </td>
                    </tr>
                    ";
                    $beneficary1++;
             ...
             <div  id="GFG16">
               <div  class="card-body">
                ...
                <tbody>
                    <?php
                    if($designation=="Admin")
                        $query = "SELECT * FROM `16_mtc` ORDER BY id DESC";
                    elseif ($designation=="DSWO")
                        $query = "SELECT * FROM `16_mtc` WHERE `district`='$district' AND `block`='$block' ORDER BY id DESC";
                    else
                        $query = "SELECT * FROM `16_mtc` WHERE `district`='$district' AND `block`='$block' AND `sector`='$sector' ORDER BY id DESC";
                    ...
                    <tr>
                        ...
                        <td>
                            <a href='delete1.php?id=" . $row['id'] . "&mtc=1' class='btn btn-outline-danger'><i class='fa-solid fa-trash-can'></i> &nbsp; Remove</a>
                        </td>
                    </tr>
                    ";
                    $beneficary1++;
             ...
             <div  id="GFG17">
               <div  class="card-body">
                ...
                <tbody>
                    <?php
                    if($designation=="Admin")
                        $query = "SELECT * FROM `17_ifa` ORDER BY id DESC";
                    elseif ($designation=="DSWO")
                        $query = "SELECT * FROM `17_ifa` WHERE `district`='$district' AND `block`='$block' ORDER BY id DESC";
                    else
                        $query = "SELECT * FROM `17_ifa` WHERE `district`='$district' AND `block`='$block' AND `sector`='$sector' ORDER BY id DESC";
                    $stmt = mysqli_query($con, $query);
                    ...
                    <tr>
                        ...
                        <td>
                        <a href='delete1.php?id=" . $row['id'] . "&ifa=1' class='btn btn-outline-danger'><i class='fa-solid fa-trash-can'></i> &nbsp; Remove</a>
                        </td>
                    </tr>
                    ";
                    $beneficary1++;
             ...
             <div  id="GFG18">
               <div  class="card-body">
                ...
                <tbody>
                    ...
                    if($designation=="Admin")
                        $query = "SELECT * FROM `18_beneficiary` ORDER BY id DESC";
                    elseif ($designation=="DSWO")
                        $query = "SELECT * FROM `18_beneficiary` WHERE `district`='$district' AND `block`='$block' ORDER BY id DESC";
                    else
                        $query = "SELECT * FROM `18_beneficiary` WHERE `district`='$district' AND `block`='$block' AND `sector`='$sector' ORDER BY id DESC";
                    $stmt = mysqli_query($con, $query);
                    ...
                    <tr>
                        ...
                        <td>
                        <a href='delete1.php?id=" . $row['id'] . "&b=1' class='btn btn-outline-danger'><i class='fa-solid fa-trash-can'></i> &nbsp; Remove</a>
                        </td>
                    </tr>
                    ";
                    $beneficary1++;
             ...
             <div  id="GFG19">
               <div  class="card-body">
                ...
                <tbody>
                    <?php
                    if($designation=="Admin")
                    $query = "SELECT * FROM `19_beneficiary_3_6` ORDER BY id DESC";
                    elseif ($designation=="DSWO")
                    $query = "SELECT * FROM `19_beneficiary_3_6` WHERE `district`='$district' AND `block`='$block' ORDER BY id DESC";
                    else
                    $query = "SELECT * FROM `19_beneficiary_3_6` WHERE `district`='$district' AND `block`='$block' AND `sector`='$sector' ORDER BY id DESC";
                    $stmt = mysqli_query($con, $query);
                    ...
                    <tr>
                        ...
                        <td>
                        <a href='delete1.php?id=" . $row['id'] . "&infra=1' class='btn btn-outline-danger'><i class='fa-solid fa-trash-can'></i> &nbsp; Remove</a>
                        </td>
                    </tr>
                    ";
                    $beneficary1++;
             ...
             <div  id="GFG20">
               <div  class="card-body">
                ...
                <tbody>
                    <?php
                    if($designation=="Admin")
                        $query = "SELECT * FROM `20_beneficiary_adol` ORDER BY id DESC";
                    elseif($designation=="DSWO")
                        $query = "SELECT * FROM `20_beneficiary_adol` WHERE `district`='$district' AND `block`='$block' ORDER BY id DESC";
                    else
                        $query = "SELECT * FROM `20_beneficiary_adol` WHERE `district`='$district' AND `block`='$block' AND `sector`='$sector' ORDER BY id DESC";
                    $stmt = mysqli_query($con, $query);
                    ...
                    <tr>
                        ...
                        <td>
                        <a href='delete1.php?id=" . $row['id'] . "&adol=1' class='btn btn-outline-danger'><i class='fa-solid fa-trash-can'></i> &nbsp; Remove</a>
                        </td>
                    </tr>
                    ";
                    $beneficary1++;
             ...
             <div  id="GFG21">
               <div  class="card-body">
                ...
                <tbody>
                    <?php
                    if($designation=="Admin")
                    $query = "SELECT * FROM `21_infra` ORDER BY id DESC";
                    elseif ($designation=="DSWO")
                    $query = "SELECT * FROM `21_infra` WHERE `district`='$district' AND `block`='$block' ORDER BY id DESC";
                    else
                    $query = "SELECT * FROM `21_infra` WHERE `district`='$district' AND `block`='$block' AND `sector`='$sector' ORDER BY id DESC";
                    $stmt = mysqli_query($con, $query);
