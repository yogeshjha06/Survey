...
if (!isset($_SESSION['is_login'])) {
    ...
    $d2=mysqli_query($con,"SELECT * FROM `tbl_block` WHERE `block_code`='$block'");
    $row1=mysqli_fetch_array($d2);
    $blo=$row1['block_name'];


    $d3=mysqli_query($con,"SELECT * FROM `tbl_sector` WHERE `sectorcode`='$sector'");
        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <h2><a href=""><?php echo $name;?>&nbsp;<i style="height: 10px; width: 10px;" class="bi bi-patch-check-fill"></i></a></h2>
              <h3><?php echo $designation." Profile Gov Jharkhand";?></h3>
              <div class="social-links mt-2">
                <a href="<?php echo $twitter;?>" target="_blank" class="twitter"><i class="bi bi-twitter"></i></a>
                <a href="<?php echo $fb;?>" target="_blank" class="facebook"><i class="bi bi-facebook"></i></a>
                <a href="<?php echo $insta;?>" target="_blank" class="instagram"><i class="bi bi-instagram"></i></a>
                <a href="<?php echo $web;?>" target="_blank" class="website"><i class="fa-brands fa-linkedin"></i></a>
              </div>
            </div>
          </div>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo $designation;?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label ">District</div>
                    <div class="col-lg-9 col-md-8"><?php echo $dis;?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label ">Block</div>
                    <div class="col-lg-9 col-md-8"><?php echo $blo;?></div>
                  </div>
