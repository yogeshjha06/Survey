                ...
                <section class="section">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">MTC Survey</h5>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv1" class="col-sm-2 col-form-label">MTC Name</label>
                                            <div class="col-sm-10">
                                                <input id="opv1" placeholder="Enter Name" name="opv1" type="text" class="form-control" required>
                                            </div>
                                        </div>

                                        <div class="row mb-4">
                                            <label for="opv2" class="col-sm-2 col-form-label">Total Bed</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv3" class="col-sm-2 col-form-label">Total Bed Occupied</label>
                                            <div class="col-sm-10">
                                    ...
                                    if (isset($_POST['submit'])) 
                                    {
                                        ...
                                        //insert data query
                                        $res = mysqli_query($con, "INSERT INTO `16_mtc`(`project`, `scheme`, `month`, `district`, `block`, `sector`, `name_mtc`, `total_bed`, `occupied_bed`, `date`, `submitted`, `submitedID`) VALUES ('$project','$scheme','$month','$district1','$block1','$sector1','$opv1','$opv2','$opv3','$date_now','$name', '$id')");
