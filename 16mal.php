                ...
                <section class="section">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Mal Nutrition Survey</h5>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv1" class="col-sm-2 col-form-label">Children Enroll (0-6 month)</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv2" class="col-sm-2 col-form-label">Children Enroll (0-5 year)</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv3" class="col-sm-2 col-form-label">Total Children Enroll For Weight Measurement</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv4" class="col-sm-2 col-form-label">Total Children Enroll For Height Measurement</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv5" class="col-sm-2 col-form-label">Margin Undernourished Children</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv6" class="col-sm-2 col-form-label">Total Undernourished Children (Treated)</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv7" class="col-sm-2 col-form-label">Total Children Referred (For MTC) From Center</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv8" class="col-sm-2 col-form-label">Total Children Admitted In MTC Center</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv9" class="col-sm-2 col-form-label">Children Follow-Up Who are Admitted In MTC Center</label>
                                            <div class="col-sm-10">
                                    ...
                                    if (isset($_POST['submit'])) {
                                        ...
                                        //insert data query
                                        $res = mysqli_query($con, "INSERT INTO `15_mal_nutrition`(`project`, `scheme`, `month`, `district`, `block`, `sector`, `0_6_Month_children`, `0_5_Year_children`, `wt_total_child`, `ht_total_child`, `undernourished_child`, `undernourished_child_treated`, `mtc`, `mtc_enroll`, `mtc_follow_up`, `date`, `submitted`, `submitedID`) VALUES ('$project','$scheme','$month','$district1','$block1','$sector1','$opv1','$opv2','$opv3','$opv4','$opv5','$opv6','$opv7','$opv8','$opv9','$date_now','$name', '$id')");
