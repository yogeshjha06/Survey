                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                ...
                                <center><h5 class="card-title text-primary">IFA Tablet Distribution Survey Edit</h5></center> 
                                    <!-- General Form Elements -->
                                    <form action="#" method="POST">
                         <?php
                         $sql = "SELECT * FROM `17_ifa` WHERE `id` = '$survey_id'";
                            $result = mysqli_query($con, $sql);
                            $row = mysqli_fetch_array($result);

                                        $opv0           = $row['pregnant_women_enroll'];
                                        $opv0_done      = $row['pregnant_women_iaf_180'];

                                        $opv1           = $row['nursing_women_enroll'];
                                        $opv1_done      = $row['nursing_women_iaf_180'];

                                        $opv2           = $row['girl_enroll'];
                                        $opv2_done      = $row['girl_iaf'];
                         ?>
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv0" class="col-sm-2 col-form-label">Pregnant Women Enroll (Target)</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv0_done" class="col-sm-2 col-form-label">Pregnant Women Recived IAF Tablets 180 (Achievement)</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv1" class="col-sm-2 col-form-label">Nursing Women Enroll (Target)</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv1_done" class="col-sm-2 col-form-label">Nursing Women Recived IAF Tablets 180 (Achievement)</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv2" class="col-sm-2 col-form-label">School Girl Enroll (Target)</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv2_done" class="col-sm-2 col-form-label">School Girl Recived IAF Tablets (Achievement)</label>
                                            <div class="col-sm-10">
                                    ...
                                    if (isset($_POST['submit'])) {
                                        ...
                                        //insert data query
                                        $res = mysqli_query($con, "UPDATE `17_ifa` SET `pregnant_women_enroll`='$opv0',`pregnant_women_iaf_180`='$opv0_done',`nursing_women_enroll`='$opv1',`nursing_women_iaf_180`='$opv1_done',`girl_enroll`='$opv2',`girl_iaf`='$opv2_done',`date`='$date_now' WHERE `id`='$survey_id'");
