                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                ...
                                <center><h5 class="card-title text-primary">PCV Survey Edit</h5></center> 
                                    <!-- General Form Elements -->
                                    <form action="#" method="POST">
                         <?php
                         $sql = "SELECT * FROM `07_pcv` WHERE `id` = '$survey_id'";
                         ...
                         ?>
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv0" class="col-sm-2 col-form-label">PCV-1 (Target)</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv0_done" class="col-sm-2 col-form-label">PCV-1 (Achived)</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv1" class="col-sm-2 col-form-label">PCV-2 (Target)</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv1_done" class="col-sm-2 col-form-label">PCV-2 (Achived)</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv2" class="col-sm-2 col-form-label">PCV-BOOSTER (Target)</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-4">
                                            <label for="opv2_done" class="col-sm-2 col-form-label">PCV-BOOSTER (Achived)</label>
                                            <div class="col-sm-10">
                                    ...
                                    if (isset($_POST['submit'])) {
                                        ...
                                        //insert data query
                                        $res = mysqli_query($con, "UPDATE `07_pcv` SET `pcv1`='$opv0',`pcv1_done`='$opv0_done',`pcv2`='$opv1',`pcv2_done`='$opv1_done',`pcv3`='$opv2',`pcv3_done`='$opv2_done',`date`='$date_now' WHERE `id`='$survey_id'");
